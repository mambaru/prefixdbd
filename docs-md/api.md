...
У всех методов, за исключением [range](#Метод-range), есть параметр **fields**. У методов [get](#Метод-get),
[has](#Метод-has) и [del](#Метод-del) - это массив ключей. У метода [set](#Метод-set) ассоциативный массив
(объект) с фактическими значениями, у остальных [inc](#Метод-inc), [add](#Метод-add) и [packed](#Метод-packed) - ассоциативный массив с параметрами обновления.
